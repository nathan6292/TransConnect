...
namespace TransConnect{
    class Program{
        static void Main(string[] args){
            ...
            Salarie directeurFinancier = new Salarie(0, "GripSous", "Mr", new DateTime(1967, 7, 19), "Adresse14", "gripsous@example.com", 1234567803, "Directeur Financier", 9000, DateTime.Now, directeurGeneral);
            Salarie directionComptable = new Salarie(0, "Picsou", "Mr", new DateTime(1972, 5, 25), "Adresse15", "picsou@example.com", 1234567804, "Direction comptable", 8000, DateTime.Now, directeurFinancier);
