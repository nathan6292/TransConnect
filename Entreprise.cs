...
public class Entreprise
    {
        ...
        public void ModifierSalarie()
        {
            ...
            int inputID = int.Parse(Tools.Saisie("Entrez l'ID du salarié à modifier : ", new Dictionary<Predicate<string>, string> { { IsInt, "L'ID n'est pas valide" }, { IsIDinSalaries, "Cet ID n'est pas dans les choix possibles" } }));
            ...
            while (!finish)
            {
                ...
                int inputChoice = int.Parse(Tools.Saisie("\nTapez le numéro correspondant à l'élément que vous voulez modifier :", new Dictionary<Predicate<string>, string> { { IsInt, "Veuillez entrer un chiffre entre 1 et " + nbChoice }, { x => int.Parse(x) >= 1 && int.Parse(x) <= nbChoice, "Veuillez entrer un chiffre entre 1 et " + nbChoice } }));
                switch (inputChoice)
                {
                    case 1:
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        Amodifier.Poste = Tools.Saisie("Entrez le nouveau poste : ", new Dictionary<Predicate<string>, string> { { IsNotEmpty, "Le poste ne peut pas être vide" } });
                        break;
                    case 5:
                        Amodifier.Salaire = double.Parse(Tools.Saisie("Entrez le nouveau salaire : ", new Dictionary<Predicate<string>, string> { { IsDouble, "Le salaire n'est pas valide" }, { IsPositive, "Le salaire ne peut pas être négatif" } }));
                        break;
                    case 6:
                        ((Chauffeur)Amodifier).TarifHoraire = double.Parse(Tools.Saisie("Entrez le nouveau tarif horaire : ", new Dictionary<Predicate<string>, string> { { IsDouble, "Le tarif horaire n'est pas valide" }, { IsPositive, "Le tarif horaire ne peut pas être négatif" } }));
                        break;
                }
